...
const HomeCard = ({
  ...
  return (
    ...
    bg-cover bg-center rounded-2xl hover:shadow-lg hover:shadow-white/10 cursor-pointer overflow-hidden duration-200 hover:-translate-y-1 relative ${className}`}
    >
